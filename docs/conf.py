...
autoapi_type = "python"
autoapi_dirs = ["../pyadjoint", "../pyadjoint/utils"]
...
latex_documents = [
    (master_doc, 'Pyadjoint.tex', 'Pyadjoint Documentation',
     'Bryant Chow', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyadjoint', 'Pyadjoint Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pyadjoint', 'Pyadjoint Documentation',
     author, 'Pyadjoint', 'Waveform misfit functions and adjoint sources',
     'Miscellaneous'),
]
